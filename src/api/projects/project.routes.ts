...
router.route('/:projectId/members/add').post(
  // restrictToProjectAccess(['OWNER', 'ADMIN']),
  addMember,
);

router.route('/:projectId/members/remove').delete(
  // restrictToProjectAccess(['OWNER', 'ADMIN']),
  removeMember,
);
router.route('/:projectId/members/role/makeAdmin').patch(
  // restrictToProjectAccess(['OWNER', 'ADMIN']),
  makeAdmin,
);
router.route('/:projectId/members/role/remove-admin').patch(
  // restrictToProjectAccess(['OWNER', 'ADMIN']),
  removeAdmin,
);
